                        ...
                        type: 'bar',
                          itemStyle:{
                                    normal:{
                                        ...
                                        {offset: 0,color: '#FF8EFF'},{offset: 1, color: '#FFD0FF'}
                                      ])
                                    }
                                },
            data: [60, 79, 90, 132, 256, 267, 306, 352, 366, 380, 399, 438,467, 554, 634, 721]
                    },
                    // {
                    //     name: '产品A/B证合计',
                    //     type: 'bar',
                        ...
                        type: 'bar',
                          itemStyle:{
                                    normal:{
                                        barBorderRadius: [10,0,0,10],
                                        color:  new this.$echarts.graphic.LinearGradient(0,0,1,0,[
                                        {offset: 0,color: 'rgba(128, 255, 115)'},{offset: 1, color: 'rgba(1, 191, 236)'}
                                      ])
                                    }
                                },
