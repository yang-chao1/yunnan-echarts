...
<script>
var color=['#00ffff','#00cfff','#006ced','#ffe000','#ffa800','#ff5b00','#ff3000','#00ffff','#00cfff','#006ced','#ffe000','#ffa800','#ff5b00','#ff3000','#00ffff','#00cfff','#006ced','#ffe000','#ffa800','#ff5b00','#ff3000']
export default {
  data() {
    return {
      chartInstance: null,
